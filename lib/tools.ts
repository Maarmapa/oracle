...
export const SCENES: Record<string, { label: string; bg: string; video?: string; overlay: string }> = {
  ...
  rio:     { label: 'Rio — Cristo Redentor', video: 'https://pub-07910030472648618f97bdbf5bddca01.r2.dev/WhatsApp%20Video%202026-05-10%20at%207.25.00%20PM.mp4', bg: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=1600&q=80', overlay: 'rgba(10,10,10,0.55)' },
